...
<body>
    ...
    <?php 
        ...
        */
        ...
        // Output: 
        $keyOfItems = ['id','name','price','description','source'];
        // foreach( $keyOfItems as $index => $keyOfitem){
        //     echo $keyOfitem." => ".$items[$index]. "<br>";
        // }
        
        $items_assosiatifArray = array(
            array(
                "id" => "001",
        ...
        foreach($items_assosiatifArray as $item){
            echo "array ( [id] => ".$item["id"]." "."[name] => ".$item["name"]." "."[price] => ".$item["price"]." "." [desctiption] => ".$item["description"]." "." [source] => ".$item["source"]." )" .'<br/>';
        };
